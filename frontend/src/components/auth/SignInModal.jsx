...
export default function SignInModal({ open, onClose }) {
  ...
  return createPortal(
    ...
    >
      ...
      >
        {/* Playful gradient header band */}
        <div className="relative overflow-hidden bg-linear-to-br from-purple-600 via-violet-600 to-purple-700 px-8 pb-10 pt-7 text-center">
          <div className="pointer-events-none absolute -left-8 -top-8 h-28 w-28 rounded-full bg-white/10 blur-2xl" />
          <div className="pointer-events-none absolute -bottom-10 -right-6 h-28 w-28 rounded-full bg-white/10 blur-2xl" />
          <button
            onClick={close}
          ...
          <img src={logo} alt="Pocket Lab" className="animate-logo-float mx-auto mb-3 h-12 w-auto drop-shadow-lg" />
              ...
              <div className="mt-5 flex items-center gap-3">
                {googleOnboarding ? (
                  <button
                    ...
                    onClick={close}
                    disabled={submitting}
                    className="flex items-center justify-center gap-1.5 rounded-2xl border-2 border-purple-100 px-5 py-3 font-extrabold text-secondary transition-colors hover:bg-purple-50 disabled:opacity-60"
                  >
                    Skip
                  </button>
                ) : (
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 rounded-2xl border-2 border-purple-100 px-5 py-3 font-extrabold text-secondary transition-colors hover:bg-purple-50"
                  >
                ...
                <button
                  ...
                  disabled={submitting}
                  className="flex flex-1 items-center justify-center gap-2 rounded-2xl bg-linear-to-r from-purple-600 to-violet-600 py-3 font-extrabold text-white shadow-lg shadow-purple-200 transition-transform hover:scale-[1.02] active:scale-95 disabled:opacity-60"
                >
            ...
            <>
              ...
              <form onSubmit={isSignup ? (e) => { e.preventDefault(); goToInterests(); } : handleLogin} className="space-y-4">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-2xl bg-linear-to-r from-purple-600 to-violet-600 py-3.5 font-extrabold text-white shadow-lg shadow-purple-200 transition-transform hover:scale-[1.02] active:scale-95 disabled:opacity-50"
                >
                  {isSignup ? (
          ...
          {!showInterests && (
            <p className="mt-6 text-center text-sm font-semibold text-secondary">
              ...
              <button
                ...
                className="font-extrabold text-purple-600 transition-colors hover:text-purple-700"
              >
