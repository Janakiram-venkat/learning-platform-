...
// ---------------------------------------------------------------------------
// MiniDOM — just enough document for the real matcher to walk.
//
// Supports what the challenge's selectors actually use: tag names and
// descendant combinators ("table thead th"). No classes, ids, attribute
// selectors or child combinators — if a future check needs one, this throws
// rather than quietly matching nothing and turning a broken check into a
// green test.
// ---------------------------------------------------------------------------
